 ...
 */
public class CallRegister extends DataEntity<CallRegister> implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -1178514385825315099L;
    ...
    public void setDicRegisterId(String dicRegisterId) {
        this.dicRegisterId = dicRegisterId == null ? null : dicRegisterId.trim();
    }
