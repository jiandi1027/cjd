 ...
 */
public class DailyMobileReportHistory extends DataEntity<DailyMobileReportHistory> implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -7178971955199961797L;
