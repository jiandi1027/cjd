...
$(function(){
	...
	dataGrid = $('#listContent').datagrid({
			url : '${ctx}/endcorrect/recidivismPerhaps/list', 
			method:'post',
			title:"涉嫌重新犯罪",
			idField : 'id',
			treeField : 'name',
			...
			columns : [ [ {
				...
				formatter : function(value, row, index) {
					...
					if(row.hasPermission==1){
						str=str+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.formatString('<a href="${ctx}/endcorrect/recidivismPerhaps/check?id={0}&auditType={1}"  title="流程处理"><span style="color:blue;"><strong><u>流程处理</u><strong></span></a>', row.id,row.auditType);
					}
					str=str+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
								+$.formatString($.formatString('<a href="${ctx}/endcorrect/recidivismPerhaps/get?id={0}"  title="详情"><span style="color:blue;"><strong><u>详情</u><strong></span></a>', row.id));
