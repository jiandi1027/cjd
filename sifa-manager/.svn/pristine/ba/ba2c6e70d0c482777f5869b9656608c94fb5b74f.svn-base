     ...
     <div align="center">
		...
		<form id="checkForm" action="" method="post">
			...
			<table>
				...
				<tr align="center">
					<td colspan="2"><a href="javascript:void(0)" id="btn1" class="easyui-linkbutton" onclick="applyCheck()">确定</a>
...
<div id="publicity" title="公示结果处理" modal=true draggable=false
		...
		<form id="publicityForm" action="" method="post">
			...
			<table id="publicityAdd">
				...
				<tr align="center">
					<td colspan="6"><a id="publicityBtn" class="easyui-linkbutton" onclick="applyPublicity()">确定</a>
		...
		<form id="procuratorateForm" action="" method="post">
			...
			<table>
				<tr>
					...
					<TD  width="35%">
						<input type="radio" name="procuratorate" value="1" checked="checked"/>同意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr align="center">
					<td colspan="2"><a id="btn3" class="easyui-linkbutton" onclick="applyProcuratorate()">确定</a>
...
<div id="tt" class="easyui-dialog" title="执法质量评定明细" style="width:800px;height:600px;padding:10px; top:190px; left:580px;background:#c4d8ed"   
    	...
    	$('#result').click(function(){
    		//alert('1111')
    		 if($("#p").length>0){
    			 ...
    			 $("#publicityAdd tr").eq(0).after("<tr id='p'>"
    						+"<td>公示意见:</td>"
    						...
    						+"<tr rowspn='3'id='p1'>"
    						+" <td>处理结果:</td>"
    						+"<td colspan='3'><input type='text' name='showAction' style='width:220px;height:80px;'"
    						+" value='' /></td>"
	...
	//提交报检查院流程表单
	function applyProcuratorate(){
		//id="\'"+id+"\'" ;
		var str=$('#procuratorateForm').serialize();
