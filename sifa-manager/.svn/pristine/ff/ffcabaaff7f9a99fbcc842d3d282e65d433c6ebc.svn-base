            ...
            <table width="100%">
                <tr>
                   <td><span class="c-red">*</span>强制措施类型:</td>
							<td>
							<select　id="coerciveMeasureKey" name="coerciveMeasureKey" class="easyui-combobox" required=true missingMessage="强制措施类型不能为空!" style="width:150px;">
							 <option value=""></option>
                ...
                <tr>
                    <td><span class="c-red">*</span>掌握信息方式:</td>
							<td>
							<select　id="dicGraspTypeKey" name="dicGraspTypeKey" class="easyui-combobox" required=true missingMessage="掌握信息方式不能为空!" style="width:150px;">
							 <option value=""></option>
                ...
                <tr>
                    <td><span class="c-red">*</span>涉嫌重新犯罪情况:</td>
                    <td colspan="5" align="left"><textarea rows="3" cols="124" id="crimeDetails" name="crimeDetails" style="height:50px;"required=true missingMessage="涉嫌重新犯罪情况不能为空!"
