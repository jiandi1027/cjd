...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
 ...
 <form  action="${ctx}/dailymgr/gradeChange/save" method="post" id="gradeChangeId">
     ...
     <div class="easyui-panel" title="相关信息" style="width:100%;padding:5px;">
           <input type="hidden" name="id" id="id" value="${gradeChange.id }"></input>
            <table width="100%" class="grid">
                ...
                <tr>
                	<th>新监管等级：</th>
                    <td colspan="8">${fns:getSysDicValueByKey('sf_culprit','dic_gldxjb_key',gradeChange.dicMonitorGradeKey ,'')}</td>
                </tr>
             <%--    <tr>
                    <td>确定监管等级缘由:</td>
     ...
     <div style="text-align: center;display: none;">
         <p colspan="4"> 
		  ...
		  <a href="javascript:void(0)" id="returnId" class="easyui-linkbutton" onclick="clearForm()">返回</a>
		   <a href="javascript:void(0)" id="returnId1" class="easyui-linkbutton" onclick="report()">返回</a>
		  </p>
    </div>
    </form>
