...
<body>
 <form  action="" method="post" id="culpritInfo">
    ...
    <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" >
     ...
     <!--<div class="easyui-panel" id="p3" title="审核信息" style="width:100%;padding:5px;margin-bottom: 30px;">
            <table width="100%" style="text-align: center;" class="grid">
                <tr>
                ...
                <tr>
                   ...
                   <c:if test="${processDetail.dicDecideType == '2'}">退回</c:if>
                   <c:if test="${processDetail.dicDecideType == '1'}">同意</c:if>
                   <c:if test="${processDetail.dicDecideType == '0'}">不同意</c:if>
                   <c:if test="${processDetail.dicDecideType == '10'}">优秀</c:if>
                   <c:if test="${processDetail.dicDecideType == '11'}">良好</c:if>
                   <c:if test="${processDetail.dicDecideType == '12'}">一般</c:if>
                   <c:if test="${processDetail.dicDecideType == '13'}">较差</c:if>
                   </td>
   ...
   <%--  </form>
		...
		class="easyui-dialog" closed=true style="width:400px;height:400px;padding:5px; top:250px; left:650px;">
    ...
    <%-- <div id="updated" title="假释信息修改" modal=true draggable=false
		class="easyui-dialog" closed=true style="width:600px; padding:5px; top:250px; left:650px;">
	...
	<!-- <div id="dd" class="easyui-dialog" title="输入质量评定明细" style="width:500px;height:400px;padding:5px; top:250px; left:650px;background:#c4d8ed"   
...
<div id="publicity" title="公示结果处理" modal=true draggable=false
		class="easyui-dialog" closed=true style="width: 400px;padding:5px; top:250px; left:650px;background:#c4d8ed">
...
<!-- <div id="tt" class="easyui-dialog" title="执法质量评定明细" style="width:800px;height:600px;padding:5px; top:190px; left:580px;background:#c4d8ed"   
        data-options="iconCls:'icon-save',resizable:true,modal:true,closed: true" >
