...
<body class="easyui-layout" id="lay">
	...
	<div region="center" border="false">
		<table class="easyui-datagrid" id="t_list_content" title="思想汇报列表"
			style="height: 400px;"
			data-options="singleSelect:true,collapsible:true,striped:true,toolbar:toolbar,loadMsg: '数据正在加载,请耐心的等待...' ,pagination:true,pageSize: 10 ,pageList:[5,10,15,20,50],fitColumns:true,url:'${ctx}/dailymgr/thinkReport/list',method:'post'">
			<thead>
				<tr>
					<th data-options="field:'culpritName',width:100,align:'center'"
						editor="text">姓名</th>
					<th data-options="field:'groupName',width:100,align:'center'"
						editor="text">司法所</th>
					<th data-options="field:'dicReportTypeKey',width:230,formatter:function(value,rowData,rowIndex){
						return sy.getDicValue('SF_THINK_REPORT','DIC_REPORT_TYPE_KEY',value,'')},align:'center'">汇报形式</th>
					<th data-options="field:'dicReportStatusKey',width:230,formatter:function(value,rowData,rowIndex){
						return sy.getDicValue('SF_THINK_REPORT','DIC_REPORT_STATUS_KEY',value,'')},align:'center'">汇报形式</th>
					<th data-options="field:'reportDate',width:100,align:'center'"
						>汇报日期</th>
...
<script type="text/javascript">
	...
	var toolbar = [ {
		...
		handler : function() {
			...
			open_layer('新增思想汇报','${ctx}/dailymgr/thinkReport/form');
	...
	function detail(id){
		var url = '${ctx}/dailymgr/thinkReport/get?id=' + id;
		open_layer('思想汇报详情',url);
	}
	
	function update(id){
		var url = '${ctx}/dailymgr/thinkReport/form?id=' + id;
		open_layer('更新思想汇报',url);
	}
