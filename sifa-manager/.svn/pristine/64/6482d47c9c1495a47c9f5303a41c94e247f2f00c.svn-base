...
<form action="" method="post" id="">
	...
	<div class="easyui-panel" id="tqzaglcfshbPrint" style="width:100%;" align="center">
		...
		<table width="100%" style="border-collapse:collapse;border-spacing:0;border-left:1px solid;border-top:1px solid;text-align: center;">
			...
			<tr>
				...
				<td style="border-right:1px solid;border-bottom:1px solid;" colspan="5">${securityPunishment.concreteFacts }</td>
			</tr>
