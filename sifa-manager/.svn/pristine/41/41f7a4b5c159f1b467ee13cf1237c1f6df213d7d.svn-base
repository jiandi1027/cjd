            ...
            <table width="100%" class="grid">
                <tr>
                   <th width="10%"><span class="c-red">*</span>处理时间：</th>
					...
					<td width="23%"><select  id="reason"  class="f1 easyui-combobox" name="reason" 
				...
				<tr>
					...
					<td width="23%">
								<input name="beginDate" id="beginDate" value="<fmt:formatDate value="${commend.beginDate}"
					...
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endDate\')}'})"/></td>
					 ...
					 <td width="23%">
					 			<input name="endDate" id="endDate" value="<fmt:formatDate value="${commend.endDate}"
									pattern="yyyy-MM-dd HH:mm:ss" />" required=true class="Wdate easyui-validatebox" 
