...
$(function(){
	...
	dataGrid = $('#listContent').datagrid({
			url : '${ctx}/endcorrect/recidivism/list', 
			method:'post',
			title:"重新犯罪",
			idField : 'id',
			treeField : 'name',
				...
				formatter : function(value, row, index) {
					...
					if(row.hasPermission==1){
						if(row.auditType=='workerReport'){
							str=str+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.formatString('<a href="${ctx}/endcorrect/recidivism/add?id={0}"  title="上报"><span style="color:blue;"><strong><u>上报</u><strong></span></a>', row.id);
						}else{
							str=str+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.formatString('<a href="${ctx}/endcorrect/recidivism/check?id={0}&auditType={1}"  title="流程处理"><span style="color:blue;"><strong><u>流程处理</u><strong></span></a>', row.id,row.auditType);
						}
					}
					str=str+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
								+$.formatString($.formatString('<a href="${ctx}/endcorrect/recidivism/get?id={0}"  title="详情"><span style="color:blue;"><strong><u>详情</u><strong></span></a>', row.id));
	...
	$('#addbtn').click(function(){
		location.href="${ctx}/endcorrect/recidivismPerhaps/add";
	}); 
	/**
	 * 增加formatString功能
