...
<body>
 <form  action="${ctx}/endcorrect/recidivismPerhaps/check" method="post" id="culpritInfo">
	<c:choose>
   ...
   <TBODY>
   <c:if test="${recidivismPerhaps.auditType ne 'workerPrint' and recidivismPerhaps.auditType ne 'workerReport'}">
   <TR>
