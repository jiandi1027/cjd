...
<form action="" method="post" id="">
	...
	<div class="easyui-panel" id="sqfxrywczmPrint" align="center" style="width:100%;">
		<div style="width:165mm;border:0;font-size: 18.6px;font-family: FangSong_GB2312;">
		<table width="100%" style="line-height:150%;letter-spacing:3px;">
			<tr>
