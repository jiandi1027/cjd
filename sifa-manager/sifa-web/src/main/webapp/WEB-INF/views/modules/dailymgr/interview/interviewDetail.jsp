     ...
     <div class="easyui-panel" title="谈话教育信息" style="width:100%;padding:10px;margin-bottom: 30px;">
           <input type="hidden" name="id" id="paroleId" value="${interview.id }"/>
            <table width="100%">
				<tr>
					<td width="10%">走访人:</td>
					<td width="23.5%"><input readonly = 'readonly' value="${interview.interviewPerson }"
						required=true missingMessage="走访人不能为空！" name="interviewPerson" id="interviewPerson"
						class="f1 easyui-textbox" /></td>
					<td width="10%">走访日期:</td>
					<td width="23.5%"><input readonly = 'readonly' value="${interview.interviewDate }"
						name="interviewDate" editable="false" class="easyui-datebox" /></td>
					<td width="10%">走访地点:</td>
					<td ><input readonly = 'readonly' value="${interview.interviewPlace }"
						required=true missingMessage="走访地址不能为空！" name="interviewPlace" id="interviewPlace"
						class="f1 easyui-textbox" /></td>
				</tr>
				<tr>
					<td >走访对象:</td>
					<td><select id="zfdx" readonly = 'readonly' class="easyui-combobox" textField="${interview.zfdx }" name="zfdx" style="width:44%">
					...
					<td>走访原因:</td>
					<td><select readonly = 'readonly' id="interviewReason" class="easyui-combobox" textField="${interview.interviewReason }" name="interviewReason" style="width:44%">
					...
					<td>行动能力:</td>
					<td><select readonly = 'readonly' id="xdnl" class="easyui-combobox" name="xdnl" textField="${interview.xdnl }" style="width:44%">
				...
				<tr>
					<td>健康状况:</td>
					<td><select readonly = 'readonly' id="jkzk" class="easyui-combobox" name="jkzk" textField="${interview.jkzk }" style="width:44%">
					...
					<td>不良嗜好:</td>
					<td><select readonly = 'readonly' id="blsh" class="easyui-combobox" name="blsh" textField="${interview.blsh }" style="width:44%">
					...
					<td>生活来源:</td>
					<td><select readonly = 'readonly' id="shly" class="easyui-combobox" name="shly" textField="${interview.shly }" style="width:44%">
				...
				<tr>
					<td>经济情况:</td>
					<td><select readonly = 'readonly' id="jjqk" class="easyui-combobox" name="jjqk" data-options="textField:'${interview.jjqk }'" style="width:44%">
					...
					<td>婚姻情况:</td>
					<td><select readonly = 'readonly' id="hyqk" class="easyui-combobox" name="hyqk" textField="${interview.hyqk }" style="width:44%">
					...
					<td>居住情况:</td>
					<td><select readonly = 'readonly' id="jzqk" class="easyui-combobox" name="jzqk" textField="${interview.jzqk }" style="width:44%">
					...
					<tr>
					<td>活动情况:</td>
					<td><select readonly = 'readonly' id="hdqk" class="easyui-combobox" name="hdqk" textField="${interview.hdqk }" style="width:44%">
							<option value="正常">正常</option>
							<option value="有私自外出可能">有私自外出可能</option>
							<option value="与社会不良人员交往">与社会不良人员交往</option>
					</select></td>
					<td>重大变故:</td>
					<td><select readonly = 'readonly' id="zdbg" class="easyui-combobox" name="zdbg" textField="${interview.zdbg }" style="width:44%">
							<option value="无">无</option>
					...
					<td>近期表现:</td>
					<td><select readonly = 'readonly' id="jqbx" class="easyui-combobox" name="jqbx" textField="${interview.jqbx }" style="width:44%">
							<option value="正常">正常</option>
