     ...
     <div class="easyui-panel" title="谈话教育信息" style="width:100%;padding:10px;margin-bottom: 30px;">
           <input type="hidden" name="id" id="paroleId" value="${talk.id }"/>
            <table width="100%">
                <tr>
                    <td width = "5%">谈话人:</td>
                    <td width = "20%"><input value="${talk.talkor }" required=true missingMessage="谈话人不能为空！" name="talkor" id="talkor" class="f1 easyui-textbox"/></td>
                     <td width = "5%">谈话地点:</td>
                    <td><input value="${talk.place }" required=true missingMessage="谈话地点不能为空！" name="place" id="place"  class="f1 easyui-textbox"/></td>
                </tr>
                 <tr>
                    <td width = "5%">谈话日期:</td>
                    <td width = "20%"><input value="${talk.talkTime }" name="talkTime"
                    editable="false" class= "easyui-datebox" /></td>
                     <td width = "5%">记录人:</td>
                    <td><input value="${talk.recorder }" name="recorder" id="recorder" class="f1 easyui-textbox" /></td>
                </tr>
                  <tr>
                    <td width = "10%">谈话开始时间:</td>
                    <td width = "23.4%"><input value="<fmt:formatDate value='${talk.talkStartTime}' pattern="yyyy-MM-dd HH:mm:ss" />" required=true missingMessage="谈话开始时间不能为空！" name="talkStartTime"
                    editable="false" class="easyui-datetimebox" /></td>
                     <td width = "10%">谈话结束时间:</td>
                    <td><input value="<fmt:formatDate value='${talk.talkEndTime}' pattern="yyyy-MM-dd HH:mm:ss" />" required=true  missingMessage="谈话结束时间不能为空！" class="easyui-datetimebox" name="talkEndTime" 
					editable="false" /></td>
                </tr>
                <tr rowspan="5">
                    <td>谈话记录：</td>
