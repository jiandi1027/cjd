            ...
            <table width="100%">
                <tr>
                    ...
                    <td><input name="dicMonitorGradeKey" id="dicMonitorGradeKey" class="easyui-combobox" required=true style="width:200px;"
                    			data-options="valueField:'id',textField:'value',url:'${ctx}/sys/sysDic/getDicOnlyByParent?parentKey=27000',panelHeight:'auto'"value="${gradeChange.dicMonitorGradeKey }"></input></td>
                </tr>
                <tr>
                    <td>确定监管等级缘由:</td>
                ...
                <tr rowspan="5">
                    <td><span class="c-red">*</span>修改原因及依据：</td>
							<td colspan="5"><input type="text" name="accountOpinion"  multiline=true 
								class="f1 easyui-textbox" value="${gradeChange.accountOpinion}"  style="width:800px;height:80px;"/></td>
                </tr> 
                <tr rowspan="5">
