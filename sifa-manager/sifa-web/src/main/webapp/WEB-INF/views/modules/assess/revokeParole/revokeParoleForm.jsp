...
<body>
 <form  action="${ctx}/jiangcheng/revokeParole/save" method="post" id="culpritInfo">
 	<c:choose>
    ...
    <div class="easyui-panel" title="撤销缓刑相关信息" style="width:100%;padding:10px;">
     		<input type="hidden" name="id" value="${revokeParole.id }"></input>
            <table width="100%">
                <tr>
                    <td><span class="c-red">*</span>违规违纪原因：</td>
                    <td colspan="5">
                    	<input type="hidden" id="reasonTypeId1" value="${fns:getSysDicValueByKey('sf_revoke_probation','REASON_TYPE_ID',revokeParole.dicReasonTypeKey,'')}"/>
                    	<select  name="dicReasonTypeKey" id="dicReasonTypeKey" editable=false required=true missingMessage="违纪原因不能为空!" value="${revokeParole.dicReasonTypeKey }"
                ...
                <tr rowspan="5">
                    <td><span class="c-red">*</span>简要违纪情况：</td>
							<td colspan="5"><input type="text" name="detailInfo" multiline=true required=true missingMessage="简要描述不能为空!"
								class="f1 easyui-textbox" value="${revokeParole.detailInfo }"  style="width:800px;height:80px;"/></td>
                </tr> 
                <tr rowspan="5">
                    <td><span class="c-red">*</span>处理依据：</td>
							<td colspan="5"><input type="text" name="fact" multiline=true required=true missingMessage="简要描述不能为空!"
								class="f1 easyui-textbox" value="${revokeParole.fact }" style="width:800px;height:80px;"/></td>
                </tr>
                <tr>
                    <td>短信发送至：</td>
					<td></td>
