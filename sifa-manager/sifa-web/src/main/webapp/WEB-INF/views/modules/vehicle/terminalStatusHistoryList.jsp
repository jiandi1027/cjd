...
<body class="easyui-layout" id="lay">
	<div region="north" border="false" collapsed="true" title="搜索条件"
		...
		<form id="searchForm">
			<table>
				<tr>
					<td>终端服务器<input name="serverName"  style="width: 100px;" /></td>
	...
	<div region="center" border="false">
		<table class="easyui-datagrid" id="t_user" title="历史轨迹列表"
			style="height: 400px;"
			data-options="singleSelect:true,collapsible:true,striped:true,toolbar:toolbar,loadMsg: '数据正在加载,请耐心的等待...' ,pagination:true,pageSize: 10 ,pageList:[5,10,15,20,50],fitColumns:true,url:'${ctx}/vehicle/terminalStatusHistory/list',method:'post'">
			<thead>
				<tr>
