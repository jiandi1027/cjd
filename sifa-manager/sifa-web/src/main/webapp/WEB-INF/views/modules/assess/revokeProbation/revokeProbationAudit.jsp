...
<form id="revokeProbationAuditForm" name="revokeProbationAuditForm" action="${ctx}/jiangcheng/revokeProbation/submitRevokeProbationAudit" method="post">
	<input type="hidden" name="taskId" value="${revokeProbation.taskId}"/>
	<input type="hidden" name="id" id="revokeProbationId" value="${revokeProbation.id}"/>
	<input type="hidden" name="auditType" value="${revokeProbation.auditType}"/>
			...
			<TR>
				<TD>
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							<tr>
								<td height=30 width="15%" align=left>违纪原因</td><td>${fns:getSysDicValueByKey('sf_revoke_probation','REASON_TYPE_ID',revokeProbation.reasonTypeId,'')}</td>
				            </tr>
				            <tr>
				                 <td height=30 width="15%" align=left>结案报告:</td><td>${revokeProbation.endCasePathName }</td>
				            </tr>
				             <tr>
				                 <td height=30 width="15%" align=left>证据材料:</td><td>${revokeProbation.notePathName }</td>
				             </tr>
							</TBODY>
						</TABLE>
					</TD>
...
<c:if test="${revokeProbation.auditType ne 'sfsReport' && revokeProbation.auditType ne 'jzkReport' 
	&& revokeProbation.auditType ne 'sfsCheck'}">
<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed>
   <TBODY>
   <TR>
				<TD background="${ctxStatic}/images/r_0.gif" width="100%">
			...
			<TR>
				<TD>
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4 bgColor=#c4d8ed
						...
						<TBODY>
							   <TR>	
									<TD height=30 width="15%" align=left >矫正科输入质量评分：${revokeProbation.handleQualityGoal }</TD>
									<TD height=30 width="15%" align=left >矫正科执法质量评分：${revokeProbation.actionQualityGoal }</TD>
									<TD height=30 width="15%" align=left >法制科执法质量评分：${revokeProbation.actionQualityGoalF }</TD>
								</TR>
								
				                 <TR>	
									<TD height=30 width="15%" align=left >矫正处输入质量评分：${revokeProbation.cityHandleQualityGoal }</TD>
									<TD height=30 width="15%" align=left >矫正处执法质量评分：${revokeProbation.cityJactionQualityGoal }</TD>
									<TD height=30 width="15%" align=left >法制处执法质量评分：${revokeProbation.cityFactionQualityGoal }</TD>
								</TR>
							</TBODY>
						</TABLE>
					</TD>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed>
   ...
   <TR>
			...
			<TR>
				<TD>
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4 bgColor=#c4d8ed
						...
						<TBODY>
							 <c:if test="${revokeProbation.auditType ne 'sfsReport' && revokeProbation.auditType ne 'jzkReport'
							  && revokeProbation.auditType ne 'jzkPrint' && revokeProbation.auditType ne 'sfsPrint'}">
							   <TR>	
									<TD height=30 width="15%" align=left >审核结果：</TD>
									<TD  width="35%">
										<input type="radio" name="decideType" checked="checked" value="1"/>同意
										<c:if test="${revokeProbation.auditType eq 'sfgCheck' }"><input type="radio" name="decideType" value="0"/>不同意</c:if>
										<input type="radio" name="decideType" value="2" />退回
									</TD>
									<c:if test="${revokeProbation.auditType eq 'sfsCheck'}">
									<TD height=30 width="15%" align=left >司法所审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="sfsyj" ></textarea>
									</TD>
									</c:if>
									<c:if test="${revokeProbation.auditType eq 'jzkCheck'}">
									<TD height=30 width="15%" align=left >矫正科审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="jzkOpinion" ></textarea>
									</TD>
									</c:if>
									<c:if test="${revokeProbation.auditType eq 'fzkCheck'}">
									<TD height=30 width="15%" align=left >法制科审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="fzkOpinion" ></textarea>
									</TD>
									</c:if>
									<c:if test="${revokeProbation.auditType eq 'xfgCheck'}">
									<TD height=30 width="15%" align=left >县分管审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="xjsfxzjgyj" ></textarea>
									</TD>
									</c:if>
									<c:if test="${revokeProbation.auditType eq 'sjzCheck'}">
									<TD height=30 width="15%" align=left >矫正处审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="jzcOpinion" ></textarea>
									</TD>
									</c:if>
									<c:if test="${revokeProbation.auditType eq 'sfzCheck'}">
									<TD height=30 width="15%" align=left >市法制处审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="fzcOpinion" ></textarea>
									</TD>
									</c:if>
									<c:if test="${revokeProbation.auditType eq 'sfgCheck'}">
									<TD height=30 width="15%" align=left >市分管审核意见</TD>
									<TD  width="35%">
										<textarea rows="3" cols="60" name="djsfxzjgyj" ></textarea>
									</TD>
									</c:if>
								</TR>
								</c:if>
				                <c:if test="${revokeProbation.auditType ne 'sfsReport' && revokeProbation.auditType ne 'jzkReport' 
									...
									&& revokeProbation.auditType ne 'jzkPrint' && revokeProbation.auditType ne 'sfsPrint'}">
			                 	<TR>	
									<TD height=30 align=left >编辑撤销缓刑建议书：</TD>
									<TD >
										<input type="button"  value="编辑" onclick="printRevokeProbationBook();"/>
									</TD>
									<c:if test="${revokeProbation.auditType eq 'jzkCheck'||revokeProbation.auditType eq 'sjzCheck'}">
								...
								<TR>	
									...
									<TD width="35%">
										<input  class="easyui-validatebox" required=true
											 missingMessage="质量评分不能为空!"  readonly="readonly" id="handleQualityGoal" name=handleQualityGoal />
									</TD>
								</TR>
								<TR>	
									...
									<TD width="35%">
										<input class="easyui-validatebox" required=true
											 missingMessage="执法质量不能为空!" readonly="readonly" id="actionQualityGoal" name="actionQualityGoal" />
									</TD>
								</TR>	
								<TR>	
									<TD height=30 align=left >呈报单位类别：</TD>
									<TD >
										<select style="width:150px;" editable=false name="submittionOrgTypeId" required=true missingMessage="呈报不能为空!" value="${revokeProbation.submittionOrgTypeId }"
								...
								<TR>	
									...
									<TD width="35%">
										<input  class="easyui-validatebox" required=true
											 missingMessage="执法质量不能为空!" readonly="readonly" id="actionQualityGoalF" name="actionQualityGoalF" />
									</TD>
								</TR>	
								</c:if>
								<c:if test="${revokeProbation.auditType eq 'sjzCheck'}">		    
								<TR>	
									...
									<TD width="35%">
										<input  class="easyui-validatebox" required=true
											 missingMessage="质量评分不能为空!"  readonly="readonly" id="cityHandleQualityGoal" name=cityHandleQualityGoal />
									</TD>
								</TR>
								<TR>	
									<TD height=30 align=left >执法质量：</TD>
									...
									<TD width="35%">
										<input  class="easyui-validatebox" required=true
											 missingMessage="执法质量不能为空!" readonly="readonly" id="cityJactionQualityGoal" name="cityJactionQualityGoal" />
									</TD>
								</TR>	
								<TR>	
									<TD height=30 align=left >呈报单位名称：</TD>
								...
								<TR>	
									...
									<TD width="35%">
										<input  class="easyui-validatebox" required=true 
											 missingMessage="执法质量不能为空!" readonly="readonly" id="cityFactionQualityGoal" name="cityFactionQualityGoal" />
									</TD>
								</TR>	
								</c:if>
							</c:if>
 	 ...
 	 <c:if test="${revokeProbation.auditType eq 'sfsReport'|| revokeProbation.auditType eq 'jzkReport'
 	 			|| revokeProbation.auditType eq 'sfsPrint' || revokeProbation.auditType eq 'jzkPrint'}">
	 <input type="hidden" name="decideType" value="1"/>
	 </c:if>
 <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed>
  <TBODY>
  	<c:if test="${revokeProbation.auditType ne 'sfsPrint'&& revokeProbation.auditType ne 'jzkPrint'}">
 	<tr>
	...
	<c:if test="${revokeProbation.auditType eq 'sfsPrint' || revokeProbation.auditType eq 'jzkPrint'}">
 	<tr>
  		<td colspan=4 align=center class=category>
		<a id="submitbtn"  class="easyui-linkbutton"   iconCls="icon-save" href="#" onclick="doAudit()">结束流程</a>
  		</td>
	</tr>
	</c:if> 
	</TBODY>
...
<div id="dd" class="easyui-window" title="输入质量评定明细" style="width:500px;height:400px;background:#c4d8ed"   
...
//编辑撤销缓刑建议表
function printRevokeProbationBook(){
...
//提交
function doAudit(){
	$("#revokeProbationAuditForm").form('submit');
}
 
$(function() {
	$('#revokeProbationAuditForm').form({
		url:'${ctx}/jiangcheng/revokeProbation/submitRevokeProbationAudit',
		onSubmit:function(){
