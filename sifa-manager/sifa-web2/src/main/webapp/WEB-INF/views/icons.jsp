...
<link rel="stylesheet" type="text/css" href="${ctxStatic }/style/css/icons-view.css?v=60" />
<script type="text/javascript" src="${ctxStatic }/clipboard/clipboard.min.js" charset="utf-8"></script>
<div class="container">
