          ...
          <%--       <tr>
                ...
                <tr rowspan="5">
                    <th><span class="c-red"></span>修改原因及依据：</th>
							<td colspan="8"><input type="text" name="accountOpinion"  multiline=true 
                ...
                <tr rowspan="5">
                    <th><span class="c-red"></span>司法所意见：</th>
							<td colspan="8"><input type="text" name="SFSOpinion"multiline=true 
     ...
     <div class="easyui-panel" id="p3" title="审批历史" style="width:100%;padding:5px;marin:0;">
      ...
      <div align="center" style="display: none;">
         <p colspan="4"> 
         	...
         	&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
		  <a class="easyui-linkbutton" id="printAudit" >打印《社区矫正人员管理等级调整审批表》</a>
