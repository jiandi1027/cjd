	 ...
	 <div class="easyui-panel" title="基本信息" style="width:100%;padding:5px;">
			<table width="100%" class="grid">
				...
				<tr>
					...
					<td><input name="adjudgeStartTime" id="adjudgeStartTime"  value="<fmt:formatDate value="${moveIn.adjudgeStartTime}" pattern="yyyy-MM-dd" />"  required=true class="Wdate easyui-validatebox" 
					...
					<td><input name="adjudgeEndTime" id="adjudgeEndTime" value="<fmt:formatDate value="${moveIn.adjudgeEndTime}" pattern="yyyy-MM-dd" />" required=true class="Wdate easyui-validatebox" 
				...
				<tr>
					...
					<td><input name="redressStartDate" id="redressStartDate" value="<fmt:formatDate value="${moveIn.redressStartDate}" pattern="yyyy-MM-dd" />"  required=true class="Wdate easyui-validatebox" 
					...
					<td><input name="redressEndDate" id="redressEndDate" value="<fmt:formatDate value="${moveIn.redressEndDate}" pattern="yyyy-MM-dd" />" required=true class="Wdate easyui-validatebox" 
