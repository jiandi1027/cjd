...
<form id="revokeProbation_saveInform" method="post">
    <input type="hidden" name="id" value="${revokeProbation.id }"/> 
...
<div style="text-align: center;display: none;">
	    <a id="revokeProbation_saveInform_btn" class="easyui-linkbutton" >提交</a>
</div>
...
$(function() {
	...
	$('#revokeProbation_saveInform').form({
		url:'${ctx}/rewardspunishment/revokeProbation/finishInform',
		onSubmit:function(){
			 progressLoad();
	...
	$('#revokeProbation_saveInform_btn').click(function(){
		$('#revokeProbation_saveInform').form('submit');
	});
