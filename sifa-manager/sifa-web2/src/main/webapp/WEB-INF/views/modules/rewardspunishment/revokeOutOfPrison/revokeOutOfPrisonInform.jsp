...
<form id="revokeOutOfPrison_saveInform" method="post">
    <input type="hidden" name="id" value="${revokeOutOfPrison.id }"/> 
...
<div style="text-align: center;display: none;">
	    <a id="revokeOutOfPrison_saveInform_btn" class="easyui-linkbutton" >提交</a>
</div>
...
$(function() {
	...
	$('#revokeOutOfPrison_saveInform').form({
		url:'${ctx}/rewardspunishment/revokeOutOfPrison/finishInform',
		onSubmit:function(){
			 progressLoad();
	...
	$('#revokeOutOfPrison_saveInform_btn').click(function(){
		$('#revokeOutOfPrison_saveInform').form('submit');
	});
