		 ...
		 <sys:sysGroup hiddenId="groupId" hiddenName="groupId" dataGridId="grade_change_list_content"/>
				...
				<table>
					...
					<tr>
						...
						<td> <input id="dicMonitorGrade" class="easyui-combobox" name="dicMonitorGrade"   editable="false"
    							data-options="valueField:'key',textField:'value',url:'${ctx}/sys/sysDic/getDicValueByParent?parentKey=27000&showAll=1&columnName=dic_gldxjb_key&tabName=sf_culprit',panelHeight:'auto'" /> </td>
					</tr>
