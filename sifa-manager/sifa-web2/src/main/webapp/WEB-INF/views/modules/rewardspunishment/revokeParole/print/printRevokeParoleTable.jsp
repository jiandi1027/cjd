...
var LODOP; //声明为全局变量 
//打印当前页
 function preview_revokeParoleTable(){
	 CreatePrintPage();
	 LODOP.PREVIEW();
} 
...
function CreatePrintPage(){
	LODOP = getLodop(document.getElementById('LODOP_OB'),document.getElementById('LODOP_EM'),document.getElementById('revokeParoleTable_PrintMsg'));
    LODOP.PRINT_INIT("撤销假释审批表");
    //设置打印纸张大小，1代表纵向打印
    LODOP.SET_PRINT_PAGESIZE(1, 0, 0, "A4");
    LODOP.ADD_PRINT_HTM(40,60,"70%","100%",$('#revokeParoleTablePrint').html());
	...
	<div>
		...
		<div class="easyui-panel" id="revokeParoleTablePrint" style="width:100%;border:0" align="center">
			...
			<div style="text-align: center;margin-bottom:40px;width:670px;">
				<span style="font-weight: bold;font-size: 24px;">撤销假释审批表</span>
			</div>
			<table width="100%" style="border-collapse:collapse;border:1px solid;text-align: left;width:670px;">
				...
				<tr>
					...
					<td colspan="5" style="width:90%;height:150px;text-align: center;border-right: 1px solid;border-bottom: 1px solid;">${revokeParole.detailInfo }</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="5" style="width:90%;height:80px;text-align: center;border-right: 1px solid;border-bottom: 1px solid;">${revokeParole.note }</td>
				</tr>
			</table>
