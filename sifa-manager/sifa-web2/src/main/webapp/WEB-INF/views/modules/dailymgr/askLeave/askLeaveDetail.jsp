...
<form action="${ctx}/dailymgr/askLeave/detail" method="post" id="askLeaveDetailForm">
	...
	<div class="easyui-panel" id="p2" title="请假信息"
	...
	<div id="pOrder" class="easyui-panel" title="流程详情" style="width: 100%; padding: 5px;">
...
$('#askLeaveWorkerPrint1').click(function (){
	var url = '${ctx}/dailymgr/askLeave/print?id=${askLeave.id}&processInstanceId=${askLeave.processInstanceId}';
