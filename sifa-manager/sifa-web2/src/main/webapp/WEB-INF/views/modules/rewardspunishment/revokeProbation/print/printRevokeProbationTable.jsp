		...
		<div id="revokeProbation_PrintMsg1"></div>
			...
			<table width="100%" style="border-collapse:collapse;border:1px solid;text-align: left;width:670px;">
				...
				<tr>
					...
					<td colspan="5" style="width:90%;height:150px;text-align: center;border-right: 1px solid;border-bottom: 1px solid;">${revokeProbation.detailInfo }</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="5" style="width:90%;height:80px;text-align: center;border-right: 1px solid;border-bottom: 1px solid;">${revokeProbation.note }</td>
				</tr>
			</table>
