...
function formatOper(val,row,index){  
	var operation='<a href="javascript:void(0);"  class="organization-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'fi-info\'" onclick="commendDetail(\''+index+'\')">详情</a>';
    return operation;
} 

//详细
function commendDetail(index){
