...
<script type="text/javascript">
    ...
    $(function() {
        resourceTree = $('#resourceTree').tree({
            url : '${ctx }/sys/sysPermisson/allTrees',
            parentField : 'pid',
            lines : true,
            checkbox : true,
            ...
            onLoadSuccess : function(node, data) {
                progressLoad();
                $.post( '${ctx }/sys/sysRole/findPermissionIdListByRoleId', {
                    id : '${sysRole.id}'
                }, function(result) {
                    var ids;
    ...
    <div data-options="region:'west'" title="系统资源" style="width: 300px; padding: 1px;">
        <div class="well well-small">
            <form id="roleGrantForm" method="post">
                <input name="id" type="hidden"  value="${sysRole.id}" readonly="readonly">
