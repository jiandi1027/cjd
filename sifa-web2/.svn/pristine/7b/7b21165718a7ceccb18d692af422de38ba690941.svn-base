...
.biaoti {
	...
	<!-- 打印界面 -->
	<div id="death_PrintMsgtwo"></div>
	<!-- 打印按钮 -->
	<a href="#" style="display: none;" class="easyui-linkbutton"
		data-options="iconCls:'fi-print icon-blue'" id="deathPrintBtn1"></a>

	<div style="height: 50px"></div>

	<div class="biaoti">社区服刑人员死亡登记表</div>
	<div style="margin: 20px 40px 20px 40px">
		<table width="100%"
			style="width: 670px; border-collapse: collapse; border-spacing: 0; border-left: 1px solid; border-top: 1px solid; text-align: center;">
			...
			<tr style="height: 50px">
				<td style="border-right: 1px solid; border-bottom: 1px solid;"
					colspan="9" width="9%">死亡时间</td>
				
				<td style="text-align:left;border-right: 1px solid; border-bottom: 1px solid;"
					colspan="91" width="91%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<fmt:formatDate
								value="${death.deathlTime }" pattern="yyyy年MM月dd日" /></td>
			</tr>
			<tr style="height: 70px">
				<td style="border-right: 1px solid; border-bottom: 1px solid;"
					colspan="9" width="9%">死亡原因</td>
				
				<td style="text-align:left;border-right: 1px solid; border-bottom: 1px solid;"
					colspan="91" width="91%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${death.deathReason }</td>
			</tr>
			
			
			<tr style="height: 120px">
				<td style="border-right: 1px solid; border-bottom: 1px solid;"
					colspan="9" width="9%">县级司法<br>行政机关<br>审核情况
				</td>
				<td style="text-align:left;border-right: 1px solid; border-bottom: 1px solid;"
					colspan="91" width="91%">
					<div>
					...
					<div style="padding-left: 75%;"><fmt:formatDate
								value="${xfgdate}" pattern="yyyy年MM月dd日" /></div>
			...
			<tr style="height: 50px">
				<td style="border-right: 1px solid; border-bottom: 1px solid;"
					colspan="9" width="9%">备注</td>
				<td style="border-right: 1px solid; border-bottom: 1px solid;"
					colspan="91" width="91%"></td>
...
<script type="text/javascript">
	...
	function CreatePrintPage()
	{
		LODOP = getLodop(document.getElementById('LODOP_OB'), document
				...
				.getElementById('death_PrintMsgtwo'));
