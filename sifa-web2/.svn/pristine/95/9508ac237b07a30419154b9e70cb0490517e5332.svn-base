	...
	<div class="easyui-panel" title="帮困解难信息" style="padding:5px;width:100%" >
		<table width="100%" class="grid" >
			<tr>
				...
				<th width="10%">解决与否：</th>
				<td width="23%"><select id="dicSolveStatusKey"
					name="dicSolveStatusKey" class="easyui-combobox"
					data-options="editable:false,panelHeight:'auto'"
					style="text-align: start; margin: 0px; padding-top: 0px; padding-bottom: 0px; height: 24px; line-height: 24px; width: 173px;"
					required="true">
						<option value="已解决">已解决</option>
						<option value="未解决">未解决</option>
				</select></td>
				<th width="10%">解决方式：</th>
				<td width="23%"><input type="text" name="dicSolveTypeKey"
					value="${helpDifficulty.dicSolveTypeKey }"
					class="f1 easyui-textbox easyui-validatebox" /></td>
				<th width="10%"><span class="c-red">*</span>监督人：</th>
				<td width="23%"><input type="text" name="monitorSolve"
					value="${helpDifficulty.monitorSolve }" required=true
					missingMessage="不能为空!" class="f1 easyui-textbox" /></td>
			</tr>
			<tr>
				<th><span class="c-red">*</span>解决时间：</th>
				<td><input type="text" name="solveDate" id="solveDate"
					value="<fmt:formatDate value="${helpDifficulty.solveDate }" 
									pattern="yyyy-MM-dd" />"
				...
				<th>补助金额：</th>
				<td><input type="text" name="subsidy"
					value="${helpDifficulty.subsidy }"
					class="f1 easyui-textbox easyui-validatebox" /></td>
				<th><span class="c-red">*</span>解决单位：</th>
				<td><input type="text" name="solveUnit"
					value="${helpDifficulty.solveUnit }" required=true
					missingMessage="不能为空!" class="f1 easyui-textbox" /></td>
			</tr>
			<tr>
				<th>困难情况记录：</th>
				<td colspan="5"><textArea class="f1 easyui-validatebox"
					...
					<br> 备注：此处最多可以输入<em class="c-red">300</em>个字，你已输入<em
