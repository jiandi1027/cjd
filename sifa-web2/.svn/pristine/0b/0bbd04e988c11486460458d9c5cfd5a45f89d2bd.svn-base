...
/**
 * GetLocationHistoryRequest.java
 *
 ...
 */
            ...
            /**
            *  GetLocationHistoryRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLocationHistoryRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLocationHistoryRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLocationHistoryRequest",
    ...
    public static class Factory{
        ...
        */
        public static GetLocationHistoryRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLocationHistoryRequest object =
                new GetLocationHistoryRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLocationHistoryRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLocationHistoryRequest)com.rowell.sifa.web.terminal.DxLocation.location.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://trace.bnet.cn/location","MDN").equals(reader.getName())){
