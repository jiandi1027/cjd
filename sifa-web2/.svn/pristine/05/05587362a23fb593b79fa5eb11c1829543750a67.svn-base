...
<form action="" method="post" id="">
	...
	<div class="easyui-panel" id="zaglcfjysPrint" align="center" style="width:100%;border:0;">
		...
		<table width="100%" style="border-collapse:separate; border-spacing:30px;">
			...
			<tr>
				<td>
					<span style = "line-height:2;letter-spacing:1.5">
			...
			<tr>
				<td>
					<span style = "letter-spacing:1.5; float:left">
						&nbsp;&nbsp;&nbsp;&nbsp;社区服刑人员签名：${securityPunishment.culprit.name}
					</span>
					<span style = "letter-spacing:1.5; float:right">
						司法局（公章）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</span>
				</td>
			</tr>
			...
			<tr>
				<td>
					<span style = "letter-spacing:1.5;">
						社区服刑人员${securityPunishment.culprit.name}：
					</span>
				</td>
			</tr>
			<tr>
				<td>
					<span style = "line-height:2;letter-spacing:1.5">
						&nbsp;&nbsp;&nbsp;&nbsp;你在社区矫正期间，，有违反监督管理规定（人民法院禁止令）的行为如下：
						${securityPunishment.fact}。根据《社区矫正实施办法》第二十三条、《广西壮族自治区社区矫正实施细则（试行）》第八十五条之规定，决定给予警告处分一次。
					</span>
				</td>
			</tr>
