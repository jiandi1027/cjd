...
<form action="" method="post" id="">
	...
	<div id="tqzaglcfshbPrint" style="width:100%;" align="center">
		<div style="width:165mm;font-size: 16px;font-family: FangSong_GB2312;">
		
		<div style="text-align: center;"><span style="font-weight: bold;">提请治安管理处罚（撤销缓刑、撤销假释、收监执行、减刑）审核表</span></div>
		...
		<table width="100%" style="border-collapse:collapse;border-spacing:0;border-left:1px solid;border-top:1px solid;text-align: center;">
			<tr>
				...
				<td style="border-right:1px solid;border-bottom:1px solid;" width="18%">${securityPunishment.culprit.name }</td>
				<td style="border-right:1px solid;border-bottom:1px solid;" width="14%">性别</td>
				<td style="border-right:1px solid;border-bottom:1px solid;" width="14%">${fns:getSysDicValueByKey('common_table', 'sex', securityPunishment.culprit.dicSexKey, '') }</td>
				<td style="border-right:1px solid;border-bottom:1px solid;" width="14%">出生年月</td>
				<td style="border-right:1px solid;border-bottom:1px solid;" width="26%"><fmt:formatDate value="${securityPunishment.culprit.birthday}" pattern="yyyy年MM月dd日" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="border-right:1px solid;border-bottom:1px solid;height:50px">${securityPunishment.culprit.crimeInfo }</td>
			...
			<tr>
				...
				<td style="border-right:1px solid;border-bottom:1px solid;text-align:left;text-indent: 2em;" colspan="5">${securityPunishment.concreteFacts }</td>
			</tr>
			
			<tr>
				<td style="border-right:1px solid;border-bottom:1px solid;">司法所<br>意见</td>
				<td style="border-right:1px solid;border-bottom:1px solid;text-align:left;text-indent: 2em;" colspan="5">
					<span style="display: block;height: 100px;"><br></span>
					<span style="padding-left: 70%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;盖&nbsp;&nbsp;章&nbsp;)</span><br>
					<span style="display: block;height: 10px;"><br></span>
					<span style="padding-left: 70%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;日</span>
					<span style="display: block;height: 10px;"><br></span>
				</td>
			</tr>
			...
			<tr>
				<td style="border-right:1px solid;border-bottom:1px solid;">地级司法<br>行政机关<br>审核意见</td>
				<td style="border-right:1px solid;border-bottom:1px solid;text-align:left;text-indent: 2em;" colspan="5">
					<span style="display: block;height: 100px;"><br></span>
					<span style="padding-left: 70%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;盖&nbsp;&nbsp;章&nbsp;)</span><br>
					<span style="display: block;height: 10px;"><br></span>
			...
			<tr>
				<td style="border-right:1px solid;border-bottom:1px solid;height:150px">备注</td>
				<td style="border-right:1px solid;border-bottom:1px solid;text-align:left;text-indent: 2em;" colspan="5"></td>
			</tr>
...
function CreatePrintPage(){
	...
	LODOP.PRINT_INIT("打印提请治安管理处罚审核表");
    //设置打印纸张大小，1代表纵向打印
    LODOP.SET_PRINT_PAGESIZE(1, 0, 0, "A4");
    LODOP.ADD_PRINT_HTM(40,60,"70%","100%",$('#tqzaglcfshbPrint').html());
