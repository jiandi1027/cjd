 ...
 */
            ...
            /**
            *  GetBusiStatRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBusiStatRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBusiStatRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBusiStatRequest",
    ...
    public static class Factory{
        ...
        */
        public static GetBusiStatRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBusiStatRequest object =
                new GetBusiStatRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBusiStatRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBusiStatRequest)com.rowell.sifa.web.terminal.DxLocation.location.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
