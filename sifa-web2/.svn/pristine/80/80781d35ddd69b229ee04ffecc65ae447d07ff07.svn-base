...
table{border:solid #add9c0; border-width:1px 0px 0px 1px;}
	...
	<form id="outofDetail" name="outofDetail" action="" method="post">
	 	<c:choose>
	...
	<div class="easyui-panel" id="p2" title="迁出信息"
		...
		<table width="100%" class="grid">
			...
			<tr>
				...
				<th>迁出事由：</th>
				<td colspan='3'>${outof.leaveReason }</td>
			...
			<tr>
				...
				<th>亲属家庭住址：</th>
				<td colspan='3'>${outof.folkAddress }</td>
			</tr>
			<tr>
				<th>司法所意见：</th>
				<td>${outof.sfsView }</td>
				<th>备注：</th>
				<td colspan='3'>${outof.note }</td>
