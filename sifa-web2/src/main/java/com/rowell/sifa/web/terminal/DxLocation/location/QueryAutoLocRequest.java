 ...
 */
            ...
            /**
            *  QueryAutoLocRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryAutoLocRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryAutoLocRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryAutoLocRequest",
    ...
    public static class Factory{
        ...
        */
        public static QueryAutoLocRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryAutoLocRequest object =
                new QueryAutoLocRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryAutoLocRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryAutoLocRequest)com.rowell.sifa.web.terminal.DxLocation.location.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
