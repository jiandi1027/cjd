...
/**
 * CancelAutoLocationRequest.java
 *
 ...
 */
            ...
            /**
            *  CancelAutoLocationRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancelAutoLocationRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://trace.bnet.cn/location",
                "cancelAutoLocationRequest",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":cancelAutoLocationRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "cancelAutoLocationRequest",
    ...
    public static class Factory{
        ...
        */
        public static CancelAutoLocationRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancelAutoLocationRequest object =
                new CancelAutoLocationRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cancelAutoLocationRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancelAutoLocationRequest)com.rowell.sifa.web.terminal.DxLocation.location.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
