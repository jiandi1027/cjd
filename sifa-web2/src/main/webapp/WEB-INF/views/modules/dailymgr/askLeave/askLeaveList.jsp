...
<script type="text/javascript">
	...
	function askLeaveSubmitAudit(taskId, id, auditType, processId){
		...
		if (auditType == 'workerReport'){
			var url = "${ctx}/dailymgr/askLeave/askLeaveReport?id=" + id + "&taskId=" + taskId + "&auditType=" + auditType + "&processInstanceId=" + processId;
			parent.$.modalDialog({
				title : '请假上报',
			...
			if (auditType == 'workerPrint'){
				...
				var url = "${ctx}/dailymgr/askLeave/askLeaveAudit?id=" + id + "&taskId=" + taskId + "&auditType=" + auditType + "&processInstanceId=" + processId;
				parent.$.modalDialog({
					title : '请假审批',
