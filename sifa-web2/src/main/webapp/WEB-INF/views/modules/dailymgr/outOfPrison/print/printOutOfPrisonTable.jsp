...
var LODOP; //声明为全局变量 
//打印当前页
 function preview_outOfPrisonTable(){
	 CreatePrintPage();
	 LODOP.PREVIEW();
} 
...
function CreatePrintPage(){
	LODOP = getLodop(document.getElementById('LODOP_OB'),document.getElementById('LODOP_EM'),document.getElementById('outOfPrisonTable_PrintMsg'));
    LODOP.PRINT_INIT("撤销缓刑审批表");
    //设置打印纸张大小，1代表纵向打印
    LODOP.SET_PRINT_PAGESIZE(1, 0, 0, "A4");
    LODOP.ADD_PRINT_HTM(40,60,"70%","100%",$('#outOfPrisonTablePrint').html());
/*     LODOP.ADD_PRINT_TEXT(1050, 370, 200, 22, "第#页/共&页");
	...
	<div>
		<div style="text-align:center;margin-top:10px;display:none">
			<a href="#" class="easyui-linkbutton" data-options="iconCls:'fi-print icon-blue'" id="outOfPrisonTablePrintBtn" onclick="preview_outOfPrisonTable()">打印当前页</a>  
			&nbsp;&nbsp;
			注：红色下划线处可输入内容
		</div>
		<div id="outOfPrisonTable_PrintMsg"></div>
		<div class="easyui-panel" id="outOfPrisonTablePrint" style="width:100%;border:0" align="center">
			...
			<div style="text-align: center;margin-bottom:40px;width:670px;">
				<span style="font-weight: bold;font-size: 24px;">延长暂予监外执行审核表</span>
			</div>
			<table width="100%" style="border-collapse:collapse;border:1px solid;text-align: left;width:670px;">
				...
				<tr>
					...
					<td colspan="5" style="width:90%;height:150px;text-align: center;border-right: 1px solid;border-bottom: 1px solid;">${outOfPrison.reason }</td>
				</tr>
				<tr>
