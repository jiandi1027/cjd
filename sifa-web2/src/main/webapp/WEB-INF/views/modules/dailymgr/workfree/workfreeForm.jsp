...
<body>
 <form  action="${ctx}/dailymgr/workfree/save" method="post" id="workfreeForm">
	...
	<input type="hidden" id="workfreeType" name="workfreeType" value="1"></input>
