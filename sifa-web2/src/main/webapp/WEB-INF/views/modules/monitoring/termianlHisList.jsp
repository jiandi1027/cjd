		...
		<table class="easyui-datagrid" id="his_list_content" style="height: 100%;"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'type',align:'center'" style="width: 10%;">终端类型</th>
					<th data-options="field:'power',align:'center',formatter:function(value,rowData,rowIndex){
							if(rowData.type=='定位手环'){
								var power = rowData.power;
								if (power != '充电中') {
									power = power.split('.')[0] + '%';
								}
								return power;
					...
					<th data-options="field:'isLive',align:'center'" style="width: 8%;">定位状态</th>
					<th data-options="field:'gpstime',align:'center',formatter:Common.formatDate" style="width: 15%;">定位时间</th>
					<th data-options="field:'_opt',align:'center',formatter:hisformatOper" style="width: 30%">定位地址</th>
				</tr>
			</thead>
		</table>
	</div>
