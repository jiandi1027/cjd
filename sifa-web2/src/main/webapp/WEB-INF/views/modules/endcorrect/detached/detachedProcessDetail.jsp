...
<div data-options="region:'east',border:true,split:false,title:'流程详情'" style="width: 370px;">
        ...
        data-options="singleSelect:true,fit:true,collapsible:true,striped:true,loadMsg: '数据正在加载,请耐心的等待...' ,fitColumns:true,url:'${ctx}/flow/processDetail/instanceDetail?processId=${detached.processInstanceId}',method:'post'">   
    <thead>   
        <tr>   
