...
<div class="easyui-layout" id="layOut13" data-options="fit:true">
	<div region="north" border="false" title="查询条件 " style="height:65px;" data-options="collapsed:true">
		<form id="workRemindSearchForm13">
			<table width="100%" class="grid">
				<tr>
					...
					<td class="search-title" style="text-align:left">
						 <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="javascript:$('#view_list_workRemind13').datagrid('load' ,$.serializeObject($('#workRemindSearchForm13')));">查询</a> &nbsp;&nbsp; 
						<a href="#" class="easyui-linkbutton"  iconCls="icon-undo" onclick="javascript:$('#layOut13').layout('collapse','north');$('#workRemindSearchForm13').form('clear');$('#view_list_workRemind13').datagrid('load', {});">取消</a></div>
					</td>
				</tr>
			</table>
		</form>
	...
	<div region="center" border="false">
		<table class="easyui-datagrid" id="view_list_workRemind13" title="待办事项列表"
			data-options="singleSelect:true,fit:true,rownumbers:true,toolbar:[{text:'查询',iconCls:'icon-search',handler:function(){$('#layOut13').layout('expand','north');}}],fitColumns:true,collapsible:true,striped:true,
