		...
		<table width="100%" style="border-collapse:separate; border-spacing:30px;">
			...
			<tr>
				...
				<div style="margin-top:3px;line-height:30px;padding:0;margin: 0;" >
					社区矫正人员<u>${moveIn.name}</u>：
				</div>
				<div style="text-indent:28px;line-height:30px;">
				按照《社区矫正实施办法》第十四条、《广西壮族自治区社区矫正实施细则（试行）》第五十八、五十九条规定，同意你由现居住地变更到新居住地<u>${moveIn.newPlace}</u>，并于<u><fmt:formatDate value="${moveIn.moveTime}" pattern="yyyy年MM月dd日" /></u>前必须到<u>${sfjGroupName}</u>报到，依法接受社区矫正。
				</div>
				</td>
			</tr>
			...
			<tr>
				<td align="right">
				<div style="margin-top:40px;">司法局（&nbsp;公章&nbsp;）</div>
				</td>
			</tr>
			<tr >
				<td align="right">
