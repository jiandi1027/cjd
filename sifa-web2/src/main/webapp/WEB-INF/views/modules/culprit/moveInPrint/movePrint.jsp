	...
	<div class="easyui-panel" id="tqzaglcfshbPrint" style="width:100%;border:0" align="center">
		...
		<table width="100%" style="border-collapse:collapse;border-spacing:0;border-left:1px solid;border-top:1px solid;text-align: center;width:680px;">
			...
			<tr style="height: 50px;">
				...
				<td style="border-right:1px solid;border-bottom:1px solid;">${fns:getSysDicValueByKey('sf_investigate','entrust_type_id',moveIn.dicPenalTypeKey ,'')}</td>
				...
				<c:if test="${not empty moveIn.redressStartDate }">
			...
			<tr style="height: 150px;">
				...
				<td style="border-right:1px solid;border-bottom:1px solid;" colspan="5" align="left">${moveIn.reason}</td>
			</tr>
			
			<tr style="height:150px;">
				<td style="border-right:1px solid;border-bottom:1px solid;">司法所<br>意见</td>
				<td style="border-right:1px solid;border-bottom:1px solid;" colspan="5" align="left">
					${moveIn.opinion }
					<span style="margin-left: 70%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;司法所(公章)</span><br>
					<span style="display: block;height: 10px;"></span>
					<span style="margin-left: 70%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;日</span>
				</td>
			</tr>
			...
			<tr style="height:150px;">
				...
				<td style="border-right:1px solid;border-bottom:1px solid;" colspan="5" align="left">
					${xfgOption}
					<span style="padding-left: 70%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;司法局(公章)</span><br>
