...
<form action="${ctx}/investigate/investigateAudit" method="post"
	id="investigateDetailForm">
	<input type="hidden" name="taskId" value="${investigate.taskId}" /> <input
		type="hidden" name="id" value="${investigate.id}" /> <input
		type="hidden" name="auditType" value="${investigate.auditType}" /> <input
		type="hidden" name="processInstanceId"
		value="${investigate.processInstanceId}" />

	<div id="investigatePrint"></div>
	<div id="investigatePrint2"></div>
	<div id="investigatePrint3"></div>
	<div class="easyui-panel" title="被调查人员基本信息"
		...
		<table width="100%" class="grid">
			...
			<tr>
				<th>出生日期：</th>
				<td><fmt:formatDate value="${investigate.bornDate}"
	...
	<div class="easyui-panel" title="调查人员基本信息"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">姓名：</th>
			...
			<tr>
				<th>调查起始：</th>
				<td><fmt:formatDate value="${investigate.begTime}"
						pattern="yyyy-MM-dd HH:mm" /></td>
				<th>调查截止：</th>
				<td><fmt:formatDate value="${investigate.endTime}"
						pattern="yyyy-MM-dd HH:mm" /></td>
			</tr>
		</table>
	</div>

	<div class="easyui-panel" title="家庭背景"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">家庭成员与调查对象相处情况：</th>
				<td colspan="3" width="90%"><textArea id="familySituation"
						name="familySituation" class="easyui-validatebox"
						readonly="readonly"
			...
			<tr>
				<th>家庭经济状况：</th>
				<td colspan="3" width="90%"><textArea id="economicStatus"
						name="economicStatus" class="easyui-validatebox"
						readonly="readonly"
			...
			<tr>
				<th>未成年对象的其他情况：</th>
				<td colspan="3" width="90%"><textArea id="minorOtherCases"
						name="minorOtherCases" class="easyui-validatebox"
						readonly="readonly"
			...
			<tr>
				<td colspan="4">
					<table class="easyui-datagrid" id="investigateMember3_list"
						title="家庭成员信息列表" style="width: 100%; height: 330px"
						...
						<thead>
							<tr>
								<th
									data-options="field:'dicRelationKey',width:'20%',align:'center'">关系</th>
	...
	<div class="easyui-panel" title="个性特点"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">生理状况：</th>
				<td width="40%">${investigate.physiConditions}</td>
				<th width="10%">心理特征：</th>
				<td width="40%">${investigate.psychFeature}</td>
			</tr>
			<tr>
				<th>性格类型：</th>
	...
	<div class="easyui-panel" title="犯罪前表现"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">

			<tr>
				<th width="10%">工作(学习)表现：</th>
				<td width="40%">${investigate.display}</td>
				<th width="10%">业余生活：</th>
				<td width="40%">${investigate.amateurLife}</td>
			</tr>
			<tr>
				<th>邻里关系：</th>
	...
	<div class="easyui-panel" title="悔罪表现"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">对犯罪行为的认识：</th>
				<td width="40%">${investigate.crimeAcquaint}</td>
				<th width="10%">悔过态度：</th>
				<td width="40%">${investigate.repentantAttitude}</td>
			</tr>
			<tr>
				<th>罚金刑履行情况及履行能力：</th>
	...
	<div class="easyui-panel" title="社会反响"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">被害人或其亲属态度：</th>
				<td width="40%">${investigate.victimAttitude}</td>
				<th width="10%">社会公众态度：</th>
				<td width="40%">${investigate.publicAttitude}</td>
			</tr>
		</table>
	</div>

	<div id="mxCheckDetailForm"></div>
	<div class="easyui-panel" title="质量评定"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">县矫正科输入质量评分：</th>
				<td width="40%"><a id="xjzksrzl" class="easyui-linkbutton"
					icons="fi-checkbox icon-blue" onclick="mxcheckdetail(1)">查看详细</a></td>
				<th width="10%">县矫正科执法质量评分：</th>
				<td width="40%"><a id="xjzksrzl" class="easyui-linkbutton"
					icons="fi-checkbox icon-blue" onclick="mxcheckdetail(2)">查看详细</a></td>
			</tr>
			<tr>
				<th width="10%">县法制科执法质量评分：</th>
				<td width="40%"><a id="xjzksrzl" class="easyui-linkbutton"
					icons="fi-checkbox icon-blue" onclick="mxcheckdetail(3)">查看详细</a></td>
				<th width="10%"></th>
				<td width="40%"></td>
			</tr>
		</table>
	...
	<div class="easyui-panel" title="监管条件"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">家庭成员态度：</th>
				<td width="40%">${investigate.familyAttitude}</td>
				<th width="10%">生活环境：</th>
				<td width="40%">${investigate.lifeEnvironment}</td>
			</tr>
			<tr>
				<th>村（居、社区）基层组织意见：</th>
				<td colspan="3" width="90%"><textArea id="basicView"
						name="basicView" class="easyui-validatebox" readonly="readonly"
	...
	<div class="easyui-panel" title="公安派出所意见"
		style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">公安派出所意见：</th>
				<td colspan="3" width="90%"><textArea id="policeView"
						name="policeView" class="easyui-validatebox" readonly="readonly"
	...
	<div class="easyui-panel" title="调查情况" style="width: 100%; padding: 5px;">
		<table width="100%" class="grid">
			<tr>
				<th width="10%">笔录附件：</th>
	...
	<div class="easyui-panel" title="流程信息"
		...
		<table width="100%" class="grid" style="text-align: center;">
			...
			<tr style="display: none;">
				<td colspan="5" align="center"><a id="workerPrint1"
					class="easyui-linkbutton">打印调查评估意见书</a> <a id="workerPrint2"
					class="easyui-linkbutton">打印审前社会调查表</a> <a id="workerPrint3"
					class="easyui-linkbutton">打印审前社会调查审批表</a> <a id="workerPrint5"
...
<script type="text/javascript">
	...
	{
		var url = '${ctx}/sys/mxCheck/list?infoType=' + infotype
				+ '&processInstanceId=${investigate.processInstanceId}';
